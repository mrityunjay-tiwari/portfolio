...
export default function TypewriterExpitle({
    sequences = [
        { text: "About Me : ", deleteAfter: true },
    ...
    return (
        <div className="relative w-full max-w-4xl mx-auto py-8 h-5 mb-12">
            <div
                className="relative text-center z-10 flex flex-col items-center justify-center"
                ref={scope}
            >
                <motion.div
                    className={cn(`text-3xl md:text-[40px]  font-mono text-black dark:text-white tracking-tight flex items-center gap-2, ${rubik.variable} font-[300]`)}
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                >
                    <span
